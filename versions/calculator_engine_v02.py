...
if __name__ == "__main__":
    ...
    g_factor_metal = EquilibriumUtils.calc_charge_factor_for_metal_binding(4, 2) # May need to revisit
    ...
    if standard_metal_h_ligand_log_k != 0:
        ...
        corrected_metal_ligand_log_k = math.log10(10**corrected_metal_ligand_log_k + 10**corrected_metal_h_ligand_log_k)
    ...
    print(f"Free metal  = {free_ca:.6e} M")
    print(f"Free ligand = {free_egta:.6e} M")
    print(f"Kd          = {kd_val:.6e} M")
