...
if __name__ == "__main__":
    ...
    for chel_idx, chelator in enumerate(chelators):
        ...
        for metal_idx, metal in enumerate(metals):
            ...
            '''
            # 9) Protonation steps => partial fraction
            ...
            # 10) Combine metal–ligand logK with chelator protonation => net logK
            # For multiple chelator-metal pairs, store logK per pair
    ...
    # 12) Build arrays for the solver, converting units to M
